...
static const uint256 hashGenesisBlock("0xc805301e8bb72d171120155a2bd868af171cc055b7fef5de19b57fca887d7279");
...
public:
    ...
    {
        // coin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // coin: get transaction coin age
...
public:
    ...
    // coin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // coin: two types of block: proof-of-work or proof-of-stake
    ...
    // coin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // coin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // coin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // coin: block index flags
    enum
    {
